...
validation_size_from_test_size = float(sys.argv[5])/float(sys.argv[4])
...
for clf_name in classifiers:
    df = train_and_save_model(clf_name, classifiers[clf_name], X_train, y_train, X_validation, y_validation)
